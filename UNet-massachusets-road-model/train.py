...
dir_img = Path('/home/kiss2024/data/Massachusetts_Roads_Dataset/tiff/')
dir_mask = Path('/home/kiss2024/data/Massachusetts_Roads_Dataset/tiff/')
...
def train_model(
    ...
    # TODO: Learning rate, patience is how many epochs
